...
{
    // Hanya izinkan spoof POST sebagai DELETE
    if (!in_array($this->request->getMethod(true), ['POST', 'DELETE'])) {
    ...
    if (!empty($data['gambar']) && file_exists(ROOTPATH . 'public/uploads/' . $data['gambar'])) {
